...
import SEMIBOLD_WOFF from './semi-bold/semiBold.woff';
import SEMIBOLD_WOFF2 from './semi-bold/semiBold.woff2';

const readexProFont: FontFaceType = {
  name: 'Readex-Pro-arabic',
  weights: [
    {
      weightName: 'light',
      woff: LIGHT_WOFF,
